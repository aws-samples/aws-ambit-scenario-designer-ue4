...
#include "VehicleTraffic.generated.h"

/**
 * Vehicle Traffic struct
 */
USTRUCT()
struct AMBIT_API FVehicleTraffic
#if CPP
...
#endif
{
    ...
    UPROPERTY(EditAnywhere, Category = VehicleTraffic,
    ...
    float Max = 0.0f;
    UPROPERTY(VisibleAnywhere, Category = VehicleTraffic, meta = (DisplayName = "Increment"))
