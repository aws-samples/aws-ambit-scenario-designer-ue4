...
private:
    ...
    // Permutation Options
    static void SetBulkPedestrianDensityMin(float NewMin);

    static TOptional<float> GetBulkPedestrianDensityMin();

    static void SetBulkPedestrianDensityMax(float NewMax);

    static TOptional<float> GetBulkPedestrianDensityMax();

    static void SetBulkTrafficDensityMin(float NewMin);

    static TOptional<float> GetBulkTrafficDensityMin();

    static void SetBulkTrafficDensityMax(float NewMax);
