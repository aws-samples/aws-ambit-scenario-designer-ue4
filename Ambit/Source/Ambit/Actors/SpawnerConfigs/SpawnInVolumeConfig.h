...
/**
 * This struct describes the configuration of an SpawnInVolume instance.
 */
struct AMBIT_API FSpawnInVolumeConfig : FSpawnerBaseConfig
{
    // Bounding Specific
    FVector BoxExtent;
